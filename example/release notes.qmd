...
- R/launch_segmentation_app.R
  ...
  - Modificação do atalho para play/pause do audio para a barra de espaço, que agora funciona tanto para "HTML player" quanto para "R session" e "External player".
