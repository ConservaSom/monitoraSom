...
Prioridades
- Fazer processo funcionar com o templates standalone
- Adicionar a função de validação por sobreposição temporal
- Implementar o restante dos diagnósticos
- Obter TN a partir de rois de outras espécies, que permanecem como TN independente do score
...
- Fazer função para converter roi_tables em standalone templates em batch
...
- Omitir mensagens fo pacote av quando forem feitas as buscas de metadados dos arquivos de audio
- Verificar a viabilidade de usar a função av::read_audio_fft para gerar os sonogramas ao longo de todo o pacote
...
- Validação:
  - Adicionar o valor do score no sonograma da detec
...
- Segmentação
  ...
  - Plotar as legendas das rois usando o ggrepel para os nomes não ficarem sobrepostos
...
launch_validation_app(
  preset_path = "/home/grosa/R_repos/monitoraSom/example/app_presets/",
  preset_name = "launching_linux_default",
  validation_user = "Rosa G. L. M.",
  templates_path = "/home/grosa/R_repos/MonitoraSomUI/ex_val_large/templates/",
  soundscapes_path = "/home/grosa/R_repos/MonitoraSomUI/ex_val_large/soundscapes",
  input_path = "/home/grosa/R_repos/MonitoraSomUI/ex_val_large/detections/validation_input.csv",
  output_path = "/home/grosa/R_repos/MonitoraSomUI/ex_val_large/detections/validation_output.csv",
  wav_cuts_path = "/home/grosa/R_repos/MonitoraSomUI/ex_val_large/detection_cuts/",
  spec_path = "/home/grosa/R_repos/MonitoraSomUI/ex_val_large/detection_spectrograms/",
  diag_tab_path = "/home/grosa/R_repos/MonitoraSomUI/ex_val_large/diagnostic_tables/",
  ...
  overwrite = FALSE,
  session_notes = "Validation app launching test"
)
