...
#' When launching the app, a xlsx spreadsheet is created within the working
...
#' \describe{
#'   \item{`Brazilian birds (Pacheco et al. 2021)`}{List of bird species from from Brazil, #' published in Pacheco et al. (2021; \doi{10.1007/s43388-021-00058-x}).}
...
#'   \item{`Brazilian amphibians (Segalla et al. 2025)`}{List of amphibian species from from Brazil, published by Segalla et al. (2021; \doi{10.5281/zenodo.4716176}).}
#'   \item{`Brazilian bats (Garbino et al. 2024)`}{List of bat species from from Brazil, published in Garbino et al. (2024; \doi{10.1590/S1984-4689.v41.e23073}).}
#' }
"roi_label_lists"
